    ...
    <div className="h-16 bg-gray-900 border-t border-gray-800 flex items-center justify-between px-4 lg:px-8 shadow-lg relative z-50">
      ...
      <div className="flex items-center space-x-2">
         <button 
          ...
          className={`p-2 rounded-lg transition-colors mr-2 ${viewState.showLibrary ? 'bg-brand-600 text-white' : 'text-gray-400 hover:bg-gray-800'}`}
          title="Open Library"
        >
          <Library size={20} />
        </button>
        ...
        <button 
          ...
          className={`p-2 rounded-lg transition-colors ${viewState.showThumbnails ? 'bg-brand-600 text-white' : 'text-gray-400 hover:bg-gray-800'}`}
        ...
        <button 
          ...
          className={`p-2 rounded-lg transition-colors ${viewState.showBookmarks ? 'bg-brand-600 text-white' : 'text-gray-400 hover:bg-gray-800'}`}
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center space-x-2 bg-gray-800 rounded-full px-4 py-1.5">
          <button 
            ...
            className="p-1 text-gray-300 hover:text-white disabled:opacity-30 transition-colors"
          >
            <ChevronLeft size={20} />
          </button>
          
          <div className="px-4 font-mono text-sm text-brand-400 min-w-[80px] text-center">
      ...
      <div className="flex items-center space-x-2">
        <button 
            ...
            className={`p-2 rounded-lg transition-colors mr-2 ${isCurrentPageBookmarked ? 'text-yellow-400 hover:text-yellow-300' : 'text-gray-400 hover:text-white'}`}
